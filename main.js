...
function createClient(options = {}) {
    ...
    function reconnect() {
        ...
        if( reconnectAttempts >= maxAttempts ){
            console.error(`[iTouch] Max reconnect attempts (${maxAttempts}) reached. Stopping reconnection.`)
            return
        }
        reconnectAttempts++
        ...
        return new Promise((_resolve, _reject) => {
            ...
            wsclient.on('message', (_data) => {
                ...
                try {
                    ...
                    console.error('[iTouch] receive message error:', _error.message)
    ...
    function destroy() {
        ...
        Object.keys(wsevents).forEach(eventId => {
            ...
            if( event ){
                event.reject(new Error('itouch client is destroyed'))
            }
        })
    }
